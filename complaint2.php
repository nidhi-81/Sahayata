      ...
      <form action="insert_complaint.php" method="POST" style="border:1px solid #ccc">
        ...
        <h1>Report Your Complaint</h1>
          ...
          <input type="text" placeholder="Enter Email" name="email" required>
            <br><br><label for ="mno"><b>PHONE : </b></label>
            ...
            <br><label for ="locality"><b>LOCALITY : </b></label>
        ...
        <br><br>
            ...
            <br><br>
                ...
                <br><input type="text"name="complaintdescription" id="grievance_details" cols="100" rows="05">
