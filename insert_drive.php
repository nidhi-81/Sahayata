    ...
    <div class="card">
            ...
            <?php
                ...
                $conn = mysqli_connect("127.0.0.1", "root", "", "complaints_database");
                    ...
                    $sql = "INSERT INTO drive_table (hashtag, organization , location ,date, time, moto, description , aim, vision)
                    VALUES ('$hashtag','$organization','$location','$date','$time','$moto','$description','$aim','$vision' )";
                
                    if(mysqli_query($conn, $sql)){
                        echo "<h3>Your drive registration recorded successfully!";
