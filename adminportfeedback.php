  ...
  <div class="leftcolumn">
    ...
    <div class="card">
      <div class="text">
        ...
        <p>Easy to use:</P>
        <p>Allows registration of grievance 24 x 7. Portal is integrated vertically above with GoI (CPGRAMS) and below with the 
          districts and its subordinate Officers Provision to submit the grievance in English.</P>
    ...
    <div class="card">
      <h3>Contact Us</h3>
        ...
        <button class="button2" style="vertical-align:middle">
          <span> 
            <a href="mailto: sahayatagrievancecell@gmail.com subject = Feedback&body = Message">
              MAIL US
            </a>
          </span>
        </button>
